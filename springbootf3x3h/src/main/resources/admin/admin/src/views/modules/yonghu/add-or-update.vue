<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="兴趣标签" prop="xingqubiaoqian">
          <el-input v-model="ruleForm.xingqubiaoqian" 
              placeholder="兴趣标签" clearable  :readonly="ro.xingqubiaoqian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="兴趣标签" prop="xingqubiaoqian">
              <el-input v-model="ruleForm.xingqubiaoqian" 
                placeholder="兴趣标签" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.youxiang = true;
          ...
          if(o=='xingqubiaoqian'){
            this.ruleForm.xingqubiaoqian = obj[o];
	    this.ro.xingqubiaoqian = true;
            continue;
          }
        }
      }
