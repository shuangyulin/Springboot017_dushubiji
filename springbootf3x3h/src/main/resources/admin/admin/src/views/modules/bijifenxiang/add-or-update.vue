        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.bijineirong" label="笔记内容" prop="bijineirong">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.bijineirong = this.ruleForm.bijineirong.replace(reg,'../../../springbootf3x3h/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
