      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.xingqubiaoqian" class="input" type="text" placeholder="兴趣标签">
			   </div>
			 </div> -->
			<el-form-item label="兴趣标签" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.xingqubiaoqian" autocomplete="off" placeholder="兴趣标签"  />
			</el-form-item>
