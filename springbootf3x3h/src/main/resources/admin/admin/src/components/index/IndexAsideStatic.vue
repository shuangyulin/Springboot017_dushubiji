...
<style lang="scss" scoped>
  ...
  .index-aside {
	...
	.menulist-item {
		...
		border-color: rgba(42, 53, 66, 1) !important;
		...
		&>.el-menu-item {
			...
			border-width: 0;
			border-style: solid;
			border-color: rgba(53, 64, 77, 1) !important;
		...
		& /deep/ .el-submenu__title {
			...
			.el-submenu__icon-arrow {
				...
				width: 12px;
				line-height: 12px;
				color: rgba(174, 178, 183, 1) !important;
				font-size: 12px;
				border-radius: 0;
				border-width: 0;
				border-style: solid;
		...
		& /deep/ .el-menu.el-menu--inline {
			...
			background-color: rgba(53, 64, 77, 1);
			box-shadow: 0 0 0px rgba(0, 0, 0, .3);
			...
			.el-menu-item {
                ...
                &.is-active {
                    ...
                    padding: 0 10px !important;
                    margin: 0;
                    color: rgba(255, 69, 0, 0.85) !important;
                    font-size: 14px;
                    border-radius: 0;
                    border-width: 0;
                    border-style: solid;
                    border-color: rgba(0, 0, 0, 0);
                    background-color: rgba(53, 64, 77, 1) !important;
